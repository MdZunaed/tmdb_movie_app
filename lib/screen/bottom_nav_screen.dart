...
class _BottomNavScreenState extends State<BottomNavScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<BottomNavController>(builder: (navController) {
      return Scaffold(
          ...
          bottomNavigationBar: GNav(
              ...
              tabs: [
                GButton(
                    icon: navController.currentIndex == 0 ? Icons.home : Icons.home_outlined, text: 'Home'),
                GButton(
                    icon: navController.currentIndex == 1
